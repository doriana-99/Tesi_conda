    ...
    for sheet_name in sheet_names:
        ...
        for _, row in df.iterrows():
            ...
            message_content = (
                ...
                f"Instructions:\n"
                f"Di seguito ci sono domande a scelta multipla basate su conoscenze mediche. Risolvetele passo dopo passo, iniziando a riassumere le informazioni disponibili. Come risposta finale, scegliere una sola opzione tra le cinque disponibili.\n"
                f"Model Answer:"
            )
